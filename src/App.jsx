 ...
 *  cosnt cacheFn = useCallback(fn, dependencies);
 * => first argument as function
 * => second is depndencies in array
 */
...
const passwordRef = useRef(null)
  ...
  const copyPasswordToClipboard = useCallback(()=>{
    ...
    //select between reanges
    // passwordRef.current?.setSelectionRange(0,3);
    window.navigator.clipboard.writeText(password);
  },[password])
  /**
   * useEffect Hook
   * useEffect is React Hook taht is lets you synchronize a component with an external system
